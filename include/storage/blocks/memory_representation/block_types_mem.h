...
struct block_head_mem {
    ...
    linked_list_CL_sys_block_head_info_mem list_cells;
};
...
struct block_data_fixed_cells_mem {
    ...
    union {
      linked_list_CL_key_mem list_keys;
      linked_list_CL_value_mem list_values;
    } list;
};
...
struct block_meta_mem {
    ...
    linked_list_CL_sys_block_avaliable_mem list_cells;
};
